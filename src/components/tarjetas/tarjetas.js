...
const Tarjetas=({data, setJugadorEliminado,setMostrarJugadores,setFormulario,})=>{

    const handler= async ()=>{
        let id=data.id
        

       let respuesta=await fetch("https://api-jugadores-u6de.onrender.com/eliminarJugador",{
            method:"delete",
            headers:{
